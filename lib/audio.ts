export type SoundKind='move'|'clear'|'celebrate'|'reroll'|'bright'|'harmony';
export async function playEffect(context:AudioContext,kind:SoundKind,stillEnabled:()=>boolean){
 ...
 const frequencies=kind==='bright'?[783.99]:kind==='harmony'?[659.25,987.77]:kind==='reroll'?[880,1320]:kind==='celebrate'?[523.25,659.25,783.99]:[kind==='clear'?660:330];
 frequencies.forEach((frequency,i)=>{
  ...
  gain.gain.setValueAtTime(kind==='bright'?.035:kind==='harmony'?.03:kind==='reroll'?.025:kind==='celebrate'?.035:.07,start);
