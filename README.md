...
Пять палочек связи рядом с ОНО заполняются по одной за 2 000 очков. На рубеже 10 000 шкала коротко загорается целиком и начинает новый цикл, в том числе без сети. Окно мягко появляется с затемнением фона; эффекты отключаются при reduced motion.
